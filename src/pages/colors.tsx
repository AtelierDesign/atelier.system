      ...
      <Grid css={{ gridTemplateColumns: 'repeat(4, 1fr)', gap: '$2', mt: '$7' }}>
        {colors.map(color => (
          ...
          >
            ...
            <Text size="2" css={{ display: 'inline', lineHeight: '25px', textTransform: 'capitalize' }}>
              {color}
            </Text>
          </Box>
        ))}
        ...
        return (
          <Box key={color} css={{ 'html.gap &': { display: 'grid', gap: '$5' } }}>
            <Box css={{ bc: color1, p: 200 }}>
              <Container size="3">
                <Heading css={{ mb: '$2', color: color12, textTransform: 'capitalize' }}>{color}</Heading>
            ...
            <Box css={{ bc: color9, p: 200 }}>
              <Container size="3">
                <Heading css={{ mb: '$2', color: getHiContrast(color), textTransform: 'capitalize' }}>{color}</Heading>
            ...
            <Box css={{ bc: color12, p: 200 }}>
              <Container size="3">
                <Heading css={{ mb: '$2', color: color2, textTransform: 'capitalize' }}>{color}</Heading>
...
function Checkbox({ children, ...props }: React.ComponentProps<'input'> & { children?: React.ReactNode }) {
  return (
    <Box>
